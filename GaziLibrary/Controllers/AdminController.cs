...
namespace GaziLibrary.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public IActionResult Books_User(string searchString)
        {
            if (!CheckUser())
            {
        ...
        public IActionResult AddBook(ImageBook imageBook)
        {
            ...
            _notyf.Success("Sách được thêm thành công", 3);
        ...
        public IActionResult UpdateBook(ImageBook imageBook)
        {
            ...
            _notyf.Warning("Sách đã được cập nhật thành công", 3);
            return RedirectToAction("Books", "Admin");
        }
        ...
        public IActionResult RevokeBorrowedBook(int id)
        {
            ...
            _notyf.Success("Cuốn sách đã bị thu hồi.", 3);
        ...
        public IActionResult DeleteBorrowedBook(int id)
        {
            ...
            _notyf.Error("Bản ghi đã bị xóa.", 3);
        ...
        public IActionResult DeleteMessage(int id)
        {
            ...
            _notyf.Success("Tin nhắn đã được đánh dấu là đã đọc.", 3);
        ...
        public IActionResult DeletedMessage(int id)
        {
            ...
            _notyf.Error("Tin nhắn đã bị xóa.", 3);
        ...
        public IActionResult AddAuthor(Author author)
        {
            ...
            _notyf.Success("Tác giả mới đã được thêm thành công.", 3);
        ...
        public IActionResult UpdateAuthor(Author author)
        {
            ...
            _notyf.Warning("Tác giả đã được cập nhật thành công.", 3);
            return RedirectToAction("Authors", "Admin");
        }
        public IActionResult DeleteAuthor(int id)
        {
            ...
            author.Status = false;
            _authorService.Update(author);
            _notyf.Error("Tác giả đã được xóa thành công.", 3);
            return RedirectToAction("Authors", "Admin");
        }
        ...
        public IActionResult AddType(Entities.Concrete.Type type)
        {
            ...
            _notyf.Success("Loại mới đã được thêm thành công.", 3);
        ...
        public IActionResult UpdateType(Entities.Concrete.Type type)
        {
            ...
            _notyf.Success("Loại đã được cập nhật thành công.", 3);
            return RedirectToAction("Types", "Admin");
        }
        public IActionResult DeleteType(int id)
        {
            ...
            type.Status = false;
            _typeService.Update(type);
            _notyf.Error("Loại đã xóa thành công.", 3);
            return RedirectToAction("Types", "Admin");
        }
        ...
        public IActionResult AddPosition(Position position)
        {
            ...
            _notyf.Success("Vị trí mới đã được thêm thành công.", 3);
        ...
        public IActionResult UpdatePosition(Position position)
        {
            ...
            _notyf.Warning("Vị trí đã được cập nhật thành công.", 3);
            return RedirectToAction("Positions", "Admin");
        }
        public IActionResult DeletePosition(int id)
        {
            ...
            _positionService.Update(position);
            _notyf.Error("Vị trí đã được xóa thành công.", 3);
            return RedirectToAction("Positions", "Admin");
        }
        ...
        public IActionResult AddUser(User user)
        {
            ...
            _notyf.Success("Người dùng mới đã được thêm thành công.", 3);
        ...
        public IActionResult UpdateUser(User user)
        {
            ...
            _notyf.Warning("Người dùng đã cập nhật.", 3);
            return RedirectToAction("Users", "Admin");
        }
        public IActionResult DeleteUser(int id)
        {
            ...
            user.Status = false;
            _userService.Update(user);
            _notyf.Error("Người dùng đã được xóa thành công.", 3);
            return RedirectToAction("Users", "Admin");
        }
